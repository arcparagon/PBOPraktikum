...
public class FrmBuku1841720149Alief extends javax.swing.JFrame {

    /**
     * Creates new form FrmBuku
     */
    public FrmBuku1841720149Alief() {
        initComponents();
        tampilkanData();
    ...
    public void tampilkanData() {
        ...
        ArrayList<Buku1841720149Alief> list = new Buku1841720149Alief().getAllAlief();
        Object[] rowData = new Object[5];
        tblBuku.setModel(new DefaultTableModel(new Object[][]{}, kolom));
        for (int i = 0; i < list.size(); i++) {
            rowData[0] = list.get(i).getmIdBukuAlief();
            rowData[1] = list.get(i).getmKategoriAlief().getmNamaAlief();
            rowData[2] = list.get(i).getmJudulAlief();
            rowData[3] = list.get(i).getmPenerbitAlief();
            rowData[4] = list.get(i).getmPenulisAlief();
    ...
    public ArrayList getKat() {
        ...
        for (int i = 0; i < kat.getAllAlief().size(); i++) {
            nama.add(kat.getAllAlief().get(i).getmNamaAlief());
        }
        return nama;
    }
    ...
    public void cari(String keyword) {
        String[] kolom = {"ID", "Kategori", "Judul", "Penerbit", "Penulis"};
        ArrayList<Buku1841720149Alief> list = new Buku1841720149Alief().searchAlief(keyword);
        Object[] rowData = new Object[5];
        tblBuku.setModel(new DefaultTableModel(new Object[][]{}, kolom));
        for (Buku1841720149Alief buk : list) {
            rowData[0] = buk.getmIdBukuAlief();
            rowData[1] = buk.getmKategoriAlief();
            rowData[2] = buk.getmJudulAlief();
            rowData[3] = buk.getmPenerbitAlief();
            rowData[4] = buk.getmPenulisAlief();
            ((DefaultTableModel) tblBuku.getModel()).addRow(rowData);
        }
    }
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        Buku1841720149Alief buk = new Buku1841720149Alief();
        buk.setmIdBukuAlief(Integer.parseInt(txtIdBuku.getText()));
        buk.setmKategoriAlief((Kategori1841720149Alief) cmbKategori.getSelectedItem());
        buk.setmJudulAlief(txtJudul.getText());
        buk.setmPenerbitAlief(txtPenerbit.getText());
        buk.setmPenulisAlief(txtPenulis.getText());
        buk.saveAlief();
        txtIdBuku.setText(Integer.toString(buk.getmIdBukuAlief()));
        tampilkanData();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Buku1841720149Alief buku = new Buku1841720149Alief().getByIdAlief(Integer.parseInt(model.getValueAt(row, 0).toString()));
        buku.deleteAlief();
        kosongkanForm();
        tampilkanData();
    ...
    private void tblBukuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblBukuMouseClicked
        ...
        buku = buku.getByIdAlief(Integer.parseInt(model.getValueAt(row, 0).toString()));
        txtIdBuku.setText(String.valueOf(buku.getmIdBukuAlief()));
        cmbKategori.getModel().setSelectedItem(buku.getmKategoriAlief().getmNamaAlief());
        txtJudul.setText(buku.getmJudulAlief());
        txtPenerbit.setText(buku.getmPenerbitAlief());
        txtPenulis.setText(buku.getmPenulisAlief());
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmBuku1841720149Alief().setVisible(true);
            }
        });
    }
