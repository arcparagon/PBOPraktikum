...
Alief() {
    ...
    public void tampilkanData() {
        ...
        ArrayList<Kategori1841720149
    Alief> list = new Kategori1841720149
    Alief().getAllAlief();
        Object rowData[] = new Object[3];

        mTblKategori.setModel(new DefaultTableModel(new Object[][]{}, kolom));

        for (Kategori1841720149
    Alief kat : list) {
    ...
    private void mBtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mBtnSimpanActionPerformed
        Kategori1841720149
    Alief kat = new Kategori1841720149
    Alief();
    ...
    private void mBtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mBtnHapusActionPerformed
        ...
        Kategori1841720149
    Alief kat = new Kategori1841720149
    Alief().getByIdAlief(Integer.parseInt(model.getValueAt(row, 0).toString()));
        kat.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmKategori1841720149
            Alief().setVisible(true);
            }
        });
    }
