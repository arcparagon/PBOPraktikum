...
public class FrmKategori1841720149Alief extends javax.swing.JFrame {

    /**
     * Creates new form FrmKategori
     */
    public FrmKategori1841720149Alief() {
        initComponents();
        tampilkanData();
        kosongkanForm();
    }
    ...
    public void tampilkanData() {
        ...
        ArrayList<Kategori1841720149Alief> list = new Kategori1841720149Alief().getAllAlief();
        Object rowData[] = new Object[3];

        mTblKategori.setModel(new DefaultTableModel(new Object[][]{}, kolom));

        for (Kategori1841720149Alief kat : list) {
            rowData[0] = kat.getmIdkategoriAlief();
            rowData[1] = kat.getmNamaAlief();
            rowData[2] = kat.getmKeteranganAlief();
    ...
    public void cari(String keyword) {
        String[] kolom = {"ID", "Nama", "Keterangan"};
        ArrayList<Kategori1841720149Alief> list = new Kategori1841720149Alief().searchAlief(keyword);
        Object rowData[] = new Object[3];
    ...
    private void mBtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mBtnSimpanActionPerformed
        ...
        kat.setmIdkategoriAlief(Integer.parseInt(mTxtIdKategori.getText()));
        kat.setmNamaAlief(mTxtNama.getText());
        kat.setmKeteranganAlief(mTxtKeterangan.getText());
        kat.saveAlief();
        mTxtIdKategori.setText(Integer.toString(kat.getmIdkategoriAlief()));
        tampilkanData();
    ...
    private void mBtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mBtnHapusActionPerformed
        ...
        Kategori1841720149Alief kat = new Kategori1841720149Alief().getByIdAlief(Integer.parseInt(model.getValueAt(row, 0).toString()));
        kat.delete();
        kosongkanForm();
        tampilkanData();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmKategori1841720149Alief().setVisible(true);
            }
        });
    }
